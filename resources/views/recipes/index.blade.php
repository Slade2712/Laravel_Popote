<x-layout>
    <h1 class="text-3xl font-bold mb-8 text-center text-black">
        Toutes les <span class="text-gold">Recettes</span>
    </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @foreach ($recipes as $recipe)
                <a href="{{ route('recipes.show', $recipe->id) }}"
                    class="block bg-white rounded-2xl shadow-md border-t-4 border-gold overflow-hidden hover:shadow-xl hover:scale-[1.02] transition">
                    ...
                    <div class="p-5">
                        ...
                        @if ($recipe->category)
                            <p class="mt-1 text-sm bg-vanilla inline-block px-3 py-1 rounded-full">
