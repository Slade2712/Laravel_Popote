                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 justify-center">
                                    <span
                                        class="relative cursor-pointer bg-transparent rounded-md font-medium text-gold group-hover:text-dark-mustard">
                            ...
                            <div x-show="afficherResultats && termeRecherche.length > 0"
                                ...
                                <template x-for="ingredient in ingredientsFiltres" :key="ingredient.id">
                                    <div @click="ajouterIngredient(ingredient)"
                                        class="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-vanilla/30 text-gray-900 transition-colors flex items-center">
