    ...
    <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-500 max-w-2xl mx-auto">
                Transformez vos ingrédients en souvenirs. Remplissez le formulaire ci-dessous pour ajouter votre plat à
                la collection.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div class="p-8 lg:col-span-2 space-y-6">
                    ...
                    <x-input name="description" label="Description courte" textarea="true" rows="2"
                        placeholder="Magnifique poulet au curry avec son riz..." />
                    <div>
                        <label for="category_id" class="block text-sm font-semibold text-gray-700 mb-1">Catégorie
                    ...
                    <x-input name="instructions" label="Instructions détaillées" required textarea="true" rows="6"
                        placeholder="Couper le poulet..." />
                </div>
                        ...
                        <div class="relative" @click.outside="afficherResultats = false">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="rou   nd" stroke-width="2"
                            ...
                            <div x-show="afficherResultats && termeRecherche.length > 0"
                                ...
                                <div x-show="ingredientsFiltres.length === 0"
                                    class="text-gray-500 py-2 pl-3 italic text-sm">
            ...
            Alpine.data('gestionnaireIngredients', (tousLesIngredientsDisponibles) => ({
                ...
                get ingredientsFiltres() {
                    ...
                    return this.baseIngredients.filter(ingredient => {
                        const correspondRecherche = ingredient.name.toLowerCase().includes(
                            this.termeRecherche.toLowerCase());
                        const pasEncoreAjoute = !this.ingredientsAjoutes.some(item => item
                            .id === ingredient.id);
                ...
                ajouterIngredient(ingredientCible) {
                    ...
                    this.$nextTick(() => {
                        ...
                        if (champsQuantite.length) champsQuantite[champsQuantite.length - 1]
                            .focus();
                    });
                },
