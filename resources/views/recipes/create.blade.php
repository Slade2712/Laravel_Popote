                ...
                <div class="p-8 lg:col-span-2 space-y-6">
                   ...
                   <div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="2" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:bg-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 transition duration-200 outline-none text-gray-800 placeholder-gray-400">{{ old('description') }}</textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea id="instructions" name="instructions" rows="8" required class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:bg-white focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 transition duration-200 outline-none text-gray-800 placeholder-gray-400">{{ old('instructions') }}</textarea>
                    </div>
                </div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:bg-gray-100 hover:border-[#D4AF37] transition group cursor-pointer relative bg-white">
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 justify-center">
                                    <span class="relative cursor-pointer bg-transparent rounded-md font-medium text-[#D4AF37] group-hover:text-[#b08d2b]">Télécharger une image</span>
                                </div>
                            </div>
                        </div>
                    </div>
